...
70p
    user = "firas.obeid@pwc.com"
    key = "YOUR _APP_KEY" #serach how to get API key for gmail account on google
    list_of_reciptients = ['user1', 'user2', 'user3', 'user4', 'user5']
    to = [s + '@pwc.com' for s in list_of_reciptients]
